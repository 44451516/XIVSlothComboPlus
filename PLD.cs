                ...
                if (actionID is FastBlade)
                {
                    ...
                    if (HasBattleTarget())
                    {
                        ...
                        if (IsEnabled(CustomComboPreset.PLD_ST_AdvancedMode_HolySpirit) &&
                            Config.PLD_ST_DivineMightTiming == 4 &&
                            HasEffect(Buffs.DivineMight) &&
                            GetBuffRemainingTime(Buffs.DivineMight) <= 2.5 &&
                            GetResourceCost(HolySpirit) <= LocalPlayer.CurrentMp)
                            return HolySpirit;
                        ...
                        {
                            if (IsEnabled(CustomComboPreset.PLD_ST_AdvancedMode_FoF) && ActionReady(FightOrFlight))
                            {
                                //修改为3GCD起手
                                ...
                                switch (choice)
                                {
                                    ...
                                    case 2:
                                    {
                                        if (WasLastAction(RoyalAuthority))
                                        {
                                            return OriginalHook(FightOrFlight);
                                        }
                                        break;
                        ...
                        {
                            if ((Config.PLD_ST_RequiescatWeave == 0 && CanSpellWeave(actionID) ||
                        ...
                        {
                            if (CanSpellWeavePlus(actionID) && !WasLastAbility(FightOrFlight))
                            {
                                if (InMeleeRange())
                                {
                            ...
                            //学习了圣灵
                            if (lastComboActionID is RiotBlade && HolyCircle.LevelChecked())
                            {
                        ...
                        if (CanSpellWeavePlus(actionID, 0.6) &&
                        ...
                        if (Config.PLD_ST_DivineMightTiming == 4 &&
                            !ActionReady(FightOrFlight) &&
                            HasEffect(Buffs.DivineMight) &&
                            GetBuffRemainingTime(Buffs.DivineMight) < 10)
                        {
                            if (GetCooldownRemainingTime(FightOrFlight) <= 7.2)
                            {
                                return HolySpirit;
                            }
                        }
                        ...
                        if (!ActionReady(FightOrFlight) && GetCooldownRemainingTime(FightOrFlight) <= 4.2)
                        {
                            if (GetBuffRemainingTime(Buffs.DivineMight) > 5)
                            {
                                if (lastComboActionID is FastBlade &&
                                    RiotBlade.LevelChecked())
                                    return RiotBlade;
                                
                                if (FastBlade.LevelChecked())
                                    return FastBlade;
                            }
                        }
                        ...
                        if (comboTime > 0)
                        {
                            ...
                            if (lastComboActionID is RiotBlade && RageOfHalone.LevelChecked())
                            {
                                if (IsEnabled(CustomComboPreset.PLD_ST_AdvancedMode_Atonement) &&
                                    ...
                                    (Config.PLD_ST_AtonementTiming == 2 ||
                                     (Config.PLD_ST_AtonementTiming == 3 && ActionWatching.CombatActions.Count(x => x == FightOrFlight) % 2 == 0)))
                                    return Atonement;

                                return (IsEnabled(CustomComboPreset.PLD_ST_AdvancedMode_HolySpirit) &&
                                    HasEffect(Buffs.DivineMight) &&
                                    GetResourceCost(HolySpirit) <= LocalPlayer.CurrentMp &&
                                    (Config.PLD_ST_DivineMightTiming == 4 || Config.PLD_ST_DivineMightTiming == 2 || (Config.PLD_ST_DivineMightTiming == 3 && ActionWatching.CombatActions.Count(x => x == FightOrFlight) % 2 == 1)))
                                    ? HolySpirit
                                    : OriginalHook(RageOfHalone);
                            }
                        }
                        ...
                        if (IsEnabled(CustomComboPreset.PLD_ST_AdvancedMode_HolySpirit) &&
                            Config.PLD_ST_DivineMightTiming == 4 &&
                            HasEffect(Buffs.DivineMight) &&
                            GetCooldownRemainingTime(FightOrFlight) >= 10 &&
                            GetResourceCost(HolySpirit) <= LocalPlayer.CurrentMp )
                            return HolySpirit;
                    }
                }
